...
<body>
    <nav class="navbar mynavbar">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                <!-- Tombol nav mobile sementara didisable
            ...
            -->
                <a class="navbar-brand" id="mynavbar-title" href="#"><strong>SMAK 1</strong></a>
            </div>
   ...
   <!-- body tag opens in header.php and ends in footer.php -->
